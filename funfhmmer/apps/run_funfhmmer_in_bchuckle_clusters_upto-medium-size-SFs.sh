...
#$ -o ../job_status/run_funfhmmer_in_bchuckle_clusters_upto-medium-size-SFs.job_$JOB_ID.task_$TASK_ID.stdout

# stderr file pathname
#$ -e ../job_status/run_funfhmmer_in_bchuckle_clusters_upto-medium-size-SFs.job_$JOB_ID.task_$TASK_ID.stderr
